...
use App\Repository\FloweringRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=FloweringRepository::class)
 */
class Flowering
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Plantes::class, inversedBy="flowerings")
     */
    private $id_plante;
