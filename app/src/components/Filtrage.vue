        ...
        <form action="#" method="post">
            <div class="form-row">
                ...
                <div class="form-group mx-2 my-4">   <!-- FILTRE TYPE -->
                    ...
                    <select name="type" id="type" class="form-control text-capitalize" v-model="params.typeSelected">
                ...
                <div class="form-group mx-2 my-4">   <!-- FILTRE ENTRETIEN -->
                    ...
                    <select name="difficulty" id="difficulty" class="form-control text-capitalize" v-model="params.difficultySelected">
                        <option selected>choisir...</option>
                ...
                <div class="form-group mx-2 my-4">   <!-- FILTRE EXPOSITION -->
                    ...
                    <select name="sunshine" id="sunshine" class="form-control text-capitalize" v-model="params.sunshineSelected">
                        <option selected>choisir...</option>
                ...
                <div class="form-group mx-2 my-4">   <!-- FILTRE ARROSAGE -->
                    ...
                    <select name="watering" id="watering" class="form-control text-capitalize" v-model="params.waterSelected">
                        <option selected>choisir...</option>
